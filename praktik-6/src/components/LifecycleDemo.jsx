...
const LifecycleDemo = () => {
  const [count, setCount] = useState(0); // Tambahkan nilai awal 0
  ...
  useEffect(() => {
    ...
    document.title = 'Lifecycle Demo'; // Contoh lain
    return () => {
  ...
  // Effect dengan dependency isVisible: run ketika isVisible berubah
  useEffect(() => {
