...
const ProductList = () => {
  ...
  const products = [
    ...
    { id: 2, name: 'Smartphone', price: 8000000, description: 'Latest smartphone' },
    { id: 3, name: 'Headphones', price: 600000, description: 'Wireless headphones' },
    { id: 4, name: 'Keyboard', price: 600000, description: 'Mechanical keyboard' },
    { id: 5, name: 'Mouse', price: 300000, description: 'Gaming mouse' },
    { id: 6, name: 'Monitor', price: 2500000, description: '24-inch monitor' },
  ];
